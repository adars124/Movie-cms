    ...
    ><div>
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <NavLink className="w-full text-center" to="/">
            <span className='text-2xl font-bold text-meta-3'>Admin Panel</span>
          </NavLink>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/cms/movies"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === '/cms/movies' || pathname.includes('movies')
                    ? 'bg-graydark dark:bg-meta-4'
                    : ''
                    }`}
                >
              ...
              <li>
                <NavLink
                  to="/cms/showtimes/list"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/showtimes/list' ||
