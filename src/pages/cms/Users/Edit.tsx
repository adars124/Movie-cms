...
const Edit = () => {
    ...
    const handleSubmit = (event: React.ChangeEvent<any>) => {
        ...
        }).then((res: AxiosResponse<any>) => navigate('/cms/users'))
            .catch(err => console.log(err));
    };
                ...
                <div className="flex flex-col gap-5.5 p-6.5">
                    ...
                    <div>
                        ...
                        <div className="relative z-20 bg-white dark:bg-form-input">
                            <select name="role_name" value={form.role_name} id="role" onChange={event => setInForm(event, form, setForm)} required className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-4 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
